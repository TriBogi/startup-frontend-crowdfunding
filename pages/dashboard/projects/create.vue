      ...
      <div class="container mx-auto relative">
        <header class="flex items-center">
          ...
          <ul class="flex items-center">
            ...
            <li>
              <a class="text-white hover:text-teal-500 text-lg px-4 py-3" href="/pricing">Project</a>
            </li>
            <li>
              <a class="text-white hover:text-teal-500 text-lg px-4 py-3" href="/features">Features</a>
            </li>
            <li>
              <a class="text-white hover:text-teal-500 text-lg px-4 py-3" href="/story">Success Stories</a>
            </li>
          </ul>
